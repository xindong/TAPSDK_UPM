...
extern NSString *const TapDBKeychainErrorDomain;

/** Account name. */
extern NSString *const TapDBKeychainAccountKey;
 ...
 */
extern NSString *const TapDBKeychainCreatedAtKey;

/** Item class. */
extern NSString *const TapDBKeychainClassKey;

/** Item description. */
extern NSString *const TapDBKeychainDescriptionKey;

/** Item label. */
extern NSString *const TapDBKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const TapDBKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const TapDBKeychainWhereKey;
...
@interface TapDBKeychain : NSObject
///-----------------------
